...
<!-- 게시판 -->
<article>
	<h1>이미지게시판[전체글개수 : <%=count%>]</h1>
	<h4>이미지게시판은 회원만 글을 쓸 수 있습니다.</h4>
	<table id="notice">
		<tr>
			<th class="tno">No.</th>
	...
	%>
		<tr onclick="location.href='read.jsp?num=<%=memberbean.getNum()%>'">
			...
			<td><%=new SimpleDateFormat("yyyy-MM-dd").format(memberbean.getDate())%></td>
