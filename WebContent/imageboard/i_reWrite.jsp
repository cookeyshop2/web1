...
<article>
	<h1>공지사항</h1>
	<form action="i_reWriteAction.jsp" method="post" name="fr" enctype="multipart/form-data">
...
%> 
	<div id="table_search">
		...
		<input type="button" value="목록" class="btn" onclick="location.href='imageboard.jsp'">
	</div>
